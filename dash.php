...
<body>
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="text-white">
          <div class="navbar-brand mb-0 p-0" style="font-size:25px; font-weight:600; letter-spacing:1px;">
  ...
  <div class="container mt-5">
    ...
    <div class="row g-4">
      ...
      <!-- CARD 4 -->
      <div class="col-md-4">
        <div class="dashboard-card" onclick="location.href='project/index.php'">
